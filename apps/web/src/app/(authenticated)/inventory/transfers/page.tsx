  ...
  return <>
    <header className="page-header">
      <div>
        ...
        <p>Every completed transfer, one row per product line, with the linked out/in movements it posted.</p>
      </div>
      <Link href="/inventory/transfers/new"><Button>Record a transfer</Button></Link>
    </header>
